...
import id.rdev.catatanpenjualan.activity.data_tas.DataTasActivity
import id.rdev.catatanpenjualan.activity.login.LoginActivity
import id.rdev.catatanpenjualan.activity.penjualan.PenjualanTas
...
class MainActivity : BaseActivity(), MainView {
    ...
    private fun initActionButton() {
        mainMenu.adapter = MenuAdapter(object : MenuAdapter.OnMenuClick {
            override fun onClick(image: Int) {
                ...
                when(image) {
                    R.drawable.ic_goods -> openDataTas()
    ...
    private fun openDataPenjualan() {
        Log.d(TAG, "Penjualan")
        startActivity<PenjualanTas>(TAGS.USER to user)
    }

    private fun openDataTas() {
        Log.d(TAG, "Data Tas")
        startActivity<DataTasActivity>(TAGS.USER to user)
    }
